  ...
  const {
    ...
    defaultValues: initialData
      ? {
          ...
          budgetCode1: initialData.budgetCode1 || '',
          budgetCode2: initialData.budgetCode2 || '',
        ...
        <CardContent className="space-y-4">
          ...
          {isAdmin && (
            <>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="budgetCode1">예산코드 1 (숙박 및 운임)</Label>
                  <Input
                    id="budgetCode1"
                    {...register('budgetCode1')}
                    placeholder="숙박 및 운임 예산 코드 입력"
                  />
                  {errors.budgetCode1 && (
                    <p className="text-sm text-red-600">{errors.budgetCode1.message}</p>
                  )}
                </div>

                <div className="space-y-2">
                  <Label htmlFor="budgetCode2">예산코드 2 (위촉수당)</Label>
                  <Input
                    id="budgetCode2"
                    {...register('budgetCode2')}
                    placeholder="위촉수당 예산 코드 입력"
                  />
                  {errors.budgetCode2 && (
                    <p className="text-sm text-red-600">{errors.budgetCode2.message}</p>
                  )}
                </div>
              </div>
